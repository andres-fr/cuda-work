// run with:
// make && ./simpleCUFFT
// nvcc -arch=sm_52 -I/home/rodriguez/cuda8/samples/common/inc -lcufft simpleCUFFT.cu -o simpleCUFFT && ./simpleCUFFT
...
#define SIGNAL_SIZE        100 // 8 bytes per element
#define FILTER_KERNEL_SIZE 11  // 4 bytes per element rounded up to multiple of 8
